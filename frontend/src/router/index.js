...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/leaves/business/create', component: BusinessTripCreate, meta: { requiresAuth: true } },
    ...
    { path: '/salaries/travel-expense', component: TravelExpense, meta: { requiresAuth: true } },
